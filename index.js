...
const newInstructor = new Instructor({
  ...
  catchPhrase: "Yayyy coding",
});
console.log(newInstructor.demo("arrays"));
console.log(newInstructor.grade(me, "arrays"));
...
console.log(newStudent.PRAssignment("arrays"));
console.log(newStudent.sprintChallenge("arrays"));
console.log(newInstructor.changeGrade(newStudent));
...
console.log(newPM.standUp("WEB33_tim"));
console.log(newPM.debugsCode(me, "arrays"));
